...
import org.russia9.updatedblocks.common.item.block.ItemGenericSlab;

import java.util.ArrayList;
import java.util.List;

public class GenericSlab extends Block implements ModBlocks.ISubBlocksBlock, IConfigurable {
